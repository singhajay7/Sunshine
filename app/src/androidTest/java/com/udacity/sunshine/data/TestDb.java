...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        SQLiteDatabase sd = new WeatherDbHelper(mContext).getWritableDatabase();

        // Create ContentValues of what you want to insert
        // (you can use the createWeatherValues TestUtilities function if you wish)
        ContentValues cv = TestUtilities.createWeatherValues(insertLocation());

        // Insert ContentValues into database and get a row ID back

        long rowId = sd.insert(WeatherContract.WeatherEntry.TABLE_NAME,null,cv);
        assertTrue(rowId!=-1);
        // Query the database and receive a Cursor back
        Cursor c = sd.rawQuery("Select * from "+ WeatherContract.WeatherEntry.TABLE_NAME,null);
        ...
        // query if you like)
        while(c.moveToNext()){
            TestUtilities.validateCurrentRecord("Data validation failed.", c, cv);
        }
